...
void RenderDevice::FillRect(float left, float top, float right, float bottom, Color c)
{
	...
	// Get!!
	ShaderFill* fill = CreateSimpleFill();
...
void RenderDevice::FillTexture(float left, float top, float right, float bottom, Texture* texture)
{
	if(!pTextVertexBuffer)
	{
		pTextVertexBuffer = *CreateBuffer();
	...
	// Get!!
	ShaderFill* fill = CreateTextureFill( texture );
	...
	vertices[0] = Vertex(Vector3f(left,  top, 0.0f), Color(255,255,255,255), 0.0f, 0.0f);
	vertices[1] = Vertex(Vector3f(right, top, 0),    Color(255,255,255,255), 1.0f, 0.0f);
	vertices[2] = Vertex(Vector3f(left,  bottom, 0), Color(255,255,255,255), 0.0f, 1.0f);
	vertices[3] = Vertex(Vector3f(left,  bottom, 0), Color(255,255,255,255), 0.0f, 1.0f);
	vertices[4] = Vertex(Vector3f(right, top, 0),    Color(255,255,255,255), 1.0f, 0.0f);
	vertices[5] = Vertex(Vector3f(right, bottom, 0), Color(255,255,255,255), 1.0f, 1.0f);
