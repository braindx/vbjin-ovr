...
#include "../LibOVR/Src/Kernel/OVR_File.h"
...
public:
	...
	virtual void UpdateTexture( Texture* texture, const void* data ) { OVR_UNUSED2( texture, data ); }
	...
	virtual void FillTexture(float left, float top, float right, float bottom, Texture* texture);
