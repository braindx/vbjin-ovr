...
public:
	...
	virtual void UpdateTexture( OVR::RenderTiny::Texture* texture, const void* data );
	...
	virtual void FillTexture(float left, float top, float right, float bottom, RenderTiny::Texture* texture);
