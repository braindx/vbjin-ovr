...
struct Material
{
    ...
    enum { MAT_WRAP = 1, MAT_WIRE = 2, MAT_ZALWAYS = 4, MAT_NOCULL = 8, MAT_TRANS = 16, MAT_POINT_FILTER = 32 };
        ...
        char* vertexShader = NULL, char* pixelShader = NULL, int vSize = 24) : Tex(t), VertexSize(vSize)
    {
        ...
        ss.Filter = flags & MAT_POINT_FILTER ? D3D11_FILTER_MIN_LINEAR_MAG_MIP_POINT : D3D11_FILTER_ANISOTROPIC;
        ss.MaxAnisotropy = 8;
        ss.MaxLOD = 15;
